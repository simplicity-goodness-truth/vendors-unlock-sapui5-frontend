sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZAPPVNDUNLOCK.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZAPPVNDUNLOCK.ZAPPVNDUNLOCK.controller.ListSelector
			 */
			 ...
			 * @return {ZAPPVNDUNLOCK.ZAPPVNDUNLOCK.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
